...
/**
 * Componente principal del ejercicio de Secuencias Genéticas.
...
@Component({
  ...
  styleUrl: './genetic.component.css'
})
export class GeneticComponent implements OnInit {
  ...
  /**
   * Definición formal del AFND de Secuencias Genéticas.
   * Patrón reconocido: K G X* F donde X ∈ {K, G, A, F}
   */
  afnd: Automata = {
   ...
   * @returns conjunto destino como string o vacío
   */
